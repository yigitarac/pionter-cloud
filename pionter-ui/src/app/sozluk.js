export const sozluk = {
  en: {
    ...
    serversDraftInfo:
      "Connect your own server and manage files from one clean dashboard.",
    addServer: "Add Server",
    noServersYet: "No servers connected yet.",
    noServersInfo:
      "Add a server to start managing files through PionterCloud. Your credentials are encrypted and never shown back in the interface.",
    ...
    cancel: "Cancel",
    save: "Save",
    saveLater: "Server credentials are encrypted before they are saved.",
    ...
    activityLogsHelp: "View recent actions from your PionterCloud account.",
    loadingActivityLogs: "Loading activity logs...",
    activityLogsLoadFailed: "Activity logs could not be loaded.",
    noActivityLogs: "No activity logs yet.",
    refreshActivityLogs: "Refresh",
    activityStatusSuccess: "Success",
    activityStatusError: "Error",
    errorCode: "Error code",
    activityActionLogin: "Login",
    activityActionLogout: "Logout",
    activityActionUpload: "Upload",
    activityActionDownload: "Download",
    activityActionPreview: "Preview",
    activityActionEditorSave: "Editor save",
    activityActionCreateFile: "Create file",
    activityActionCreateFolder: "Create folder",
    activityActionRename: "Rename",
    activityActionMove: "Move",
    activityActionDelete: "Delete",
    activityActionShareCreate: "Share created",
    activityActionShareRevoke: "Share revoked",
    activityActionServerCreate: "Server created",
    activityActionServerUpdate: "Server updated",
    activityActionServerDelete: "Server deleted",
    latestActivityLoadFailed: "Latest activity could not be loaded.",
    lastActivityUploaded: "Uploaded",
    lastActivityCreated: "Created",
    lastActivityEdited: "Edited",
    lastActivityRenamed: "Renamed",
    lastActivityMoved: "Moved",
    lastActivityShared: "Shared",
    lastActivityShareRevoked: "Share revoked",
    editItem: "Edit",
  ...
  tr: {
    ...
    serversDraftInfo:
      "Kendi sunucunu bağla ve dosyalarını tek bir temiz panelden yönet.",
    addServer: "Sunucu Ekle",
    noServersYet: "Henüz bağlı sunucu yok.",
    noServersInfo:
      "Dosyalarını PionterCloud üzerinden yönetmeye başlamak için bir sunucu ekle. Kimlik bilgilerin şifreli saklanır ve arayüzde tekrar gösterilmez.",
    ...
    cancel: "Vazgeç",
    save: "Kaydet",
    saveLater: "Sunucu kimlik bilgileri kaydedilmeden önce şifrelenir.",
    ...
    selectVisible: "Listelenenleri seç",
    ...
    activityLogsHelp: "PionterCloud hesabındaki son işlemleri görüntüle.",
    loadingActivityLogs: "Aktivite logları yükleniyor...",
    activityLogsLoadFailed: "Aktivite logları getirilemedi.",
    noActivityLogs: "Henüz aktivite logu yok.",
    refreshActivityLogs: "Yenile",
    activityStatusSuccess: "Başarılı",
    activityStatusError: "Hata",
    errorCode: "Hata kodu",
    activityActionLogin: "Giriş",
    activityActionLogout: "Çıkış",
    activityActionUpload: "Yükleme",
    activityActionDownload: "İndirme",
    activityActionPreview: "Önizleme",
    activityActionEditorSave: "Editör kaydı",
    activityActionCreateFile: "Dosya oluşturma",
    activityActionCreateFolder: "Klasör oluşturma",
    activityActionRename: "Yeniden adlandırma",
    activityActionMove: "Taşıma",
    activityActionDelete: "Silme",
    activityActionShareCreate: "Paylaşım oluşturma",
    activityActionShareRevoke: "Paylaşım iptali",
    activityActionServerCreate: "Sunucu oluşturma",
    activityActionServerUpdate: "Sunucu güncelleme",
    activityActionServerDelete: "Sunucu silme",
    latestActivityLoadFailed: "Son aktivite bilgisi getirilemedi.",
    lastActivityUploaded: "Yüklendi",
    lastActivityCreated: "Oluşturuldu",
    lastActivityEdited: "Düzenlendi",
    lastActivityRenamed: "Yeniden adlandırıldı",
    lastActivityMoved: "Taşındı",
    lastActivityShared: "Paylaşıldı",
    lastActivityShareRevoked: "Paylaşım iptal edildi",
    editItem: "Düzenle",
    propertiesItem: "Özellikler",
    fileProperties: "Özellikler",
    typeColumn: "Tür",
    latestActivity: "Son aktivite",
    noLatestActivity: "Henüz aktivite yok",
  },
};
